...
for i = percentual % para a taxa de treinamento indo de 10 a 80 por cento
    ...
    for j = 1:20 % executar 20 vezes
        ...
        [y,Ta,mc] = KNN(3,x,d,x_teste,d_teste); % Executa o algoritmo KNN para (3) Vizinhos mais próximos
...
xlswrite('dadosGerados/KNN_3_Taxa_de_Acerto',acertos); % Salva a matriz final de Taxas de acertos com os critérios pedidos em um arquivo .xls
xlswrite('dadosGerados/KNN_3_Matriz_de_Confusão',matrizconfusao); % Salva a matriz final de confusões em um arquivo .xls
